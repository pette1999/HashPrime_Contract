...
contract CoreScript is Test, Script, Configuration {
    ...
    uint256 public constant _scrollSepoliaChainId = 534351;
    ...
    function deployCore(address _admin) public {
        ...
        // Rate rateToken = new Rate(address(rewardDistributorProxy));
    ...
    /// ------------ HTOKEN MARKET ACTIVIATION BUILD ------------
