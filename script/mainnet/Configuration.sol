...
contract Configuration is Test, Script, Addresses {
    ...
    function setupCtokenList() public {
        // USDT
        ...
        // iSEI:
        // Redstone: 0xC49F0Dd98F38C525A7ce15E73E60675456F3a161
        // API3:
        // Pyth:
        hTokenConfigurations[block.chainid].push(
            RTokenConfiguration({
                ...
                chainlinkPriceFeed: address(0),
                initialMintAmount: 1,
                collateralFactor: 0.7e6,
                reserveFactor: 0.3e6,
                seizeShare: 0.03e6,
                supplyCap: 1000000000e6,
                borrowCap: 500000000e6,
                priceFeedName: "iSEI_ORACLE",
                tokenAddressName: "iSEI",
                name: "iSEI",
                symbol: "tiSEI",
                addressesString: "iSEI",
                jrm: JumpRateModelConfiguration({
                    baseRatePerYear: 0.05 ether,
                    multiplierPerYear: 0.025 ether,
                    jumpMultiplierPerYear: 4.2 ether,
        ...
        // SEI
        // Redstone: 0x100c8e61aB3BeA812A42976199Fc3daFbcDD7272
        // API3: 0x09c6e594DE2EB633902f00B87A43b27F80a31a60
        // Pyth: ID 0x53614f1cb0c031d4af66c04cb9c756234adad0e1cee85303795091499a4084eb
        hTokenConfigurations[block.chainid].push(
            RTokenConfiguration({
                decimal: 18,
                price: 1e18,
                ...
                tokenAddressName: "WSEI",
                name: "WSEI",
                symbol: "tWSEI",
                addressesString: "WSEI",
                jrm: JumpRateModelConfiguration({
                    baseRatePerYear: 0.05 ether,
                    multiplierPerYear: 0.025 ether,
                    jumpMultiplierPerYear: 4.2 ether,
