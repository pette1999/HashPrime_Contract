...
/**
 * @title HashPrime's WhitePaperInterestRateModel Contract
 * @author HashPrime
 * @notice The parameterized model described in section 2.4 of the original HashPrime Protocol whitepaper
 */
